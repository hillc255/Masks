...
Masks is a content management system built on Django's "high-level Python web framework." </br>
The application uses Django's Administration module to manage digital information in a dashboard format.</br>
Sources to "do-it-yourself (DIY) face masks or coverings" found on public sites are displayed in the dashboard.</br>
